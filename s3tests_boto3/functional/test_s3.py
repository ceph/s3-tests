...
def _cors_request_and_check_neofs_s3(method, url, headers, expected_status, expected_headers, with_creds=False):
...
@attr(assertion='returning cors header')
@attr('cors-neofs-s3')
def test_cors_origin_response_neofs_s3():
    bucket_name = _setup_bucket_acl(bucket_acl='public-read')
    client = get_client()
    ...
    _cors_request_and_check_neofs_s3(method='GET', url=url, headers={},
                                     expected_status=200, expected_headers=no_origin_header)

    _cors_request_and_check_neofs_s3(method='GET', url=url, headers={'Origin': 'http://www.example1.com'},
                                     expected_status=200,  expected_headers={response_origin_header: '*'})
    _cors_request_and_check_neofs_s3(method='GET', url=obj_url, headers={'Origin': 'http://www.example1.com'},
                                     expected_status=404, expected_headers={response_origin_header: '*'})
    _cors_request_and_check_neofs_s3(method='PUT', url=obj_url, headers={'Origin': 'http://www.example1.com'},
                                     expected_status=200, expected_headers={response_origin_header: 'http://www.example1.com'})
    _cors_request_and_check_neofs_s3(method='DELETE', url=obj_url, headers={'Origin': 'http://www.example1.com'},
                                     expected_status=204, expected_headers={response_origin_header: 'http://www.example1.com'})

    _cors_request_and_check_neofs_s3(method='GET', url=url, headers={'Origin': 'http://www.example3.com'},
                                     expected_status=200, expected_headers={response_origin_header: '*'})
    _cors_request_and_check_neofs_s3(method='GET', url=obj_url, headers={'Origin': 'http://www.example3.com'},
                                     expected_status=404, expected_headers={response_origin_header: '*'})
    _cors_request_and_check_neofs_s3(method='PUT', url=obj_url, headers={'Origin': 'http://www.example3.com'},
                                     expected_status=200, expected_headers=no_origin_header)
    _cors_request_and_check_neofs_s3(method='DELETE', url=obj_url, headers={'Origin': 'http://www.example3.com'},
                                     expected_status=204, expected_headers={response_origin_header: 'http://www.example3.com'})

    _cors_request_and_check_neofs_s3(method='GET', url=url, headers={'Origin': 'http://not.exists'},
                                     expected_status=200, expected_headers={response_origin_header: '*'})
    _cors_request_and_check_neofs_s3(method='GET', url=obj_url, headers={'Origin': 'http://not.exists'},
                                     expected_status=404, expected_headers={response_origin_header: '*'})
    _cors_request_and_check_neofs_s3(method='PUT', url=obj_url, headers={'Origin': 'http://not.exists'},
                                     expected_status=200, expected_headers=no_origin_header)
    _cors_request_and_check_neofs_s3(method='DELETE', url=obj_url, headers={'Origin': 'http://not.exists'},
                                     expected_status=204, expected_headers=no_origin_header)

    _cors_request_and_check_neofs_s3(method='OPTIONS', url=url,
                                     headers={'Origin': 'http://www.example1.com', 'Access-Control-Request-Method': 'GET'},
                                     expected_status=200,
    ...
    _cors_request_and_check_neofs_s3(method='OPTIONS', url=url,
                                     ...
                                     expected_status=200,
                                     expected_headers={response_origin_header: 'http://www.example1.com', response_methods_header: 'PUT, DELETE'})
    _cors_request_and_check_neofs_s3(method='OPTIONS', url=url,
                                     headers={'Origin': 'http://www.example2.com',
                                              'Access-Control-Request-Method': 'DELETE'},
                                     expected_status=200, expected_headers={response_origin_header: 'http://www.example2.com', response_methods_header: 'DELETE'})
    _cors_request_and_check_neofs_s3(method='OPTIONS', url=url,
                                     headers={'Origin': 'http://www.example2.com',
    ...
    _cors_request_and_check_neofs_s3(method='OPTIONS', url=url,
                                     ...
                                     expected_status=200, expected_headers={response_origin_header: '*', response_methods_header: 'GET'})
    _cors_request_and_check_neofs_s3(method='OPTIONS', url=url,
                                     headers={'Origin': 'http://not.exists', 'Access-Control-Request-Method': 'PUT'},
                                     expected_status=403, expected_headers=no_origin_header)

    #with_credentials
    _cors_request_and_check_neofs_s3(method='GET', url=url, headers={'Origin': 'http://www.example1.com'}, expected_status=None,
                                     expected_headers={response_origin_header: 'http://www.example1.com'}, with_creds=True)
    _cors_request_and_check_neofs_s3(method='PUT', url=obj_url, headers={'Origin': 'http://www.example1.com'}, expected_status=None,
                                     expected_headers={response_origin_header: 'http://www.example1.com'}, with_creds=True)
    _cors_request_and_check_neofs_s3(method='GET', url=url, headers={'Origin': 'http://not.exists'}, expected_status=None,
                                     expected_headers={response_origin_header: 'http://not.exists'}, with_creds=True)
...
@attr(assertion='returning cors header')
@attr('cors-neofs-s3')
def test_cors_origin_wildcard_neofs_s3():
    bucket_name = _setup_bucket_acl(bucket_acl='public-read')
    client = get_client()
...
@attr(assertion='returning cors header')
@attr('cors-neofs-s3')
def test_cors_header_option_neofs_s3():
    bucket_name = _setup_bucket_acl(bucket_acl='public-read')
    client = get_client()
